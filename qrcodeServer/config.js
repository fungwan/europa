...
var config={
    ...
    mysql: {
        host: '127.0.0.1',//erathinko.mysql.rds.aliyuncs.com
        user: 'root',//qrtest
        password: '123123',//q6!ObNej
        port: '3306',
        database: 'qr',//test_db
        pool: {
            max: 20,
    ...
    email: {
        ...
        sitehost: 'http://erathink.tunnel.qydev.com/',
        //邮件确认超时时间
        hours: 2
    },
    page: {
    ...
    wechat:{
        ...
        appSecret:"011487ab75d517e0796eb0bb0734e9fa",
        appToken: 'erathink',
        mch_id: '1454197902',
    ...
    services:{
        ...
        wxpayserver: {
            ...
            notifyurl:'http://erathink.tunnel.qydev.com/wx/paynotify',
            interfaces:{
